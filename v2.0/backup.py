...
inventory_treeview = ttk.Treeview(frame, columns=("Ürün Tanımı", "Seri No", "Parça No", "Firma Yeri", "Adet", "Durum"), show="headings", style="Treeview")
...
inventory_treeview.heading("Firma Yeri", text="Firma Yeri", anchor="w")
